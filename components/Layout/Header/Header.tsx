          ...
          <div>
            ...
            >
              <ul className="h-screen md:h-auto items-center justify-center md:flex ">
                <li className="pb-6 text-xl text-accent py-2 md:px-6 text-center border-b-2 md:border-b-0  hover:bg-secondary  border-secondary  md:hover:text-secondary md:hover:bg-transparent">
